      ...
      <label style={{
        ...
        <div>
          ...
          <div className="ds-body-sm" style={{ color: "var(--muted-foreground)", fontSize: 12 }}>
            ...
            переключения, автоответчик, конференц-режимы. Будут добавлены сразу со статусом{" "}
            <b>«Без записи»</b> — для общей статистики. Разбор нейросетью по ним не запускается,
