  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 8, flex: 1 }}>
          ...
          <div>
            ...
            <div className="ds-body-sm" style={{ color: "var(--muted-foreground)", marginTop: 2 }}>
              {dryRun ? (
                <>Предохранитель <b>включён</b>. Записи в Bitrix CRM, отправка в Telegram-бот клиента и другие
                ...
                отправляются клиентам. Будьте уверены что готовы.</>
              )}
            </div>
          </div>
        </div>
      ...
      <div className="ds-body-sm" style={{ color: "var(--muted-foreground)", fontSize: 11, lineHeight: 1.5 }}>
        ...
        не было ситуации «забыли поставить предохранитель и снесли клиенту половину карточек».
      </div>
    </div>
  );
}
