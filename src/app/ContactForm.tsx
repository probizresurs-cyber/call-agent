...
/**
 * Форма заявки на лендинге Call-Pilot с 152-ФЗ обвязкой.
 *
 ...
 * принуждать).
 *
 * После успешной отправки НЕ открываем демо-доступ автоматически — просто
 * показываем экран "спасибо, свяжемся в ближайшее время" (заявка уже сохранена
 * в БД, менеджер свяжется по указанному телефону).
 */
